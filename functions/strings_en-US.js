...
const categories = [
  ...
  },
  {
    ...
    "suggestion": "Services",
    "facts": [
      "D E C offers automation for CERT conform O S Hardening, and Patching,.",
      "D E C offers Admin Access Solution to access your workloads in the cloud,.",
      "D E C can help you implementing the Entitelement Services for your end user application Multifactor Authentication,.",
      "D E C can help you connecting your Intranet workloads to your cloud workloads, for example over a VPN connection,.",
      "Wanna connect to the Active Directory? no Problem, D E C has a service to help you connecting your workload to the A D,.",
      "You can order an Amazon A W S, or a Microsoft Azure account using My I T in less than 5 minutes,."
    ],
  ...
  },
  {
    ...
    "facts": [
      "D E C offers 2 types of consultancy, Implementations consulting, as well as Architecture, Processes, and Strategy Consulting,.",
      "D E C consultancy, is ordered in 8 hours blocks, however you pay per hour only after consumption,.",
      "To order D E C consulting service, you can go to the My I T protal, search for A W S or Azure and click on Consultancy,.",
      "D E C consultancy related travel costs are charged separately, and 50% of travel time is charged at the hourly rate,.",
      "D E C consultancy is priced per hour,. 85€ per hour for the Implementation consulting, and 125€ per hour for the other consulting activites,."
    ],
...
const transitions = {
  "content": {
    "heardItAll": "Looks like you've heard all there is to know about the %s of D E C. Would you like to talk about anything else instead?,.",
